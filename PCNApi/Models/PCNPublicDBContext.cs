...
namespace PCNApi.Models
{
    public partial class PCNPublicDBContext : DbContext
    {
        public PCNPublicDBContext()
        {
        }

        public PCNPublicDBContext(DbContextOptions<PCNPublicDBContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ItemId })
                    .HasName("PK__order_it__837942D47BA95A02");
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164CC1C845D")
                    .IsUnique();
            ...
            modelBuilder.Entity<Stock>(entity =>
            {
                entity.HasKey(e => new { e.StoreId, e.ProductId })
                    .HasName("PK__stocks__E68284D35E8061A0");
